...
<div class="word row">
	...
	<div class="word-expander" style="display: none">
		<form action="{{URL::to(" /comparisons/$word->
			id/check")}}"> <input type="hidden" style="display: none"
				value="{{$word->id}}" name="id" /> <label for="comperativ">Comperativ</label>
			<input name="comperativ" type="text" id="comperativ"><br> <label
				for="superlative">superlative</label> <input name="superlative"
				type="text" id="superlative"><br>
